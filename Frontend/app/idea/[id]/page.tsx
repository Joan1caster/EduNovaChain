...
import { IdeaInfo, TagType } from "@/app/types";
    ...
    <div>
      ...
      <div className="flex justify-between items-center my-2">
        ...
        <div className="flex items-end">
          ...
          <span className="text-base leading-none ml-4">{info.view}</span>
          <span className="text-[0.6rem] text-gray-400 ml-1 leading-none">
            浏览
          </span>
          <span className="text-base leading-none ml-4">{info.buy}</span>
          <span className="text-[0.6rem] text-gray-400 ml-1 leading-none">
            购买
          </span>
      ...
      {/* record start */}
      <div className="h-min-52 grid grid-cols-2 gap-4 my-4">
